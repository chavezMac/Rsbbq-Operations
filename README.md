...
- **On every push/PR to `master`:** Builds the DocC archive and uploads the static site as an artifact.
- **On push to `master`:** Deploys the documentation to **GitHub Pages** (if enabled).
